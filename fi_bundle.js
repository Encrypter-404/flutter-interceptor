...
`);
      ...
      var platformConfig = {};
      if (Java.available) {
        platformConfig = config2["android"];
      } else if (Process.platform === "darwin") {
        platformConfig = config2["ios"];
      } else if (Process.platform in config2) {
        platformConfig = config2[Process.platform];
      } else {
...
`);
    ...
    function hook_ssl_verify_peer_cert(address, retval) {
      try {
        ...
        console.log("[+] ssl_verify_peer_cert has been patched (replace)");
      } catch (e) {
        try {
          Interceptor.attach(address, {
            onLeave: function(rv) {
              rv.replace(ptr(retval));
            }
          });
          console.log("[+] ssl_verify_peer_cert hooked via attach-fallback (retval=" + retval + ")");
        } catch (e2) {
          console.log("[!] ssl_verify_peer_cert: replace AND attach failed: " + e2);
        }
      }
    }
  }
  var init_flutter_wrapped = __esm({
    "flutter_wrapped.js"() {
      init_node_globals();
    }
  });
  ...
  // hooks_all.js
  var require_hooks_all = __commonJS({
    "hooks_all.js"() {
      init_node_globals();
      init_flutter_wrapped();
      var O = globalThis.FI_OPTS || { ssl: true, root: true, vpn: false };
      function jperform(fn) {
        if (typeof Java === "undefined" || !Java.available) {
          setTimeout(() => jperform(fn), 80);
          return;
        }
        Java.perform(fn);
      }
      function javaSSL() {
        jperform(function() {
          ...
          try {
            ...
            T.verifyChain.implementation = function(c, h, a, o, t) {
              return c;
            };
            ok("Conscrypt.verifyChain");
          } catch (e) {
          }
          try {
          ...
          try {
            var TM = Java.use("javax.net.ssl.X509TrustManager"), C = Java.use("javax.net.ssl.SSLContext");
            var TA = Java.registerClass({ name: "fig.TA", implements: [TM], methods: { checkClientTrusted: function() {
            }, checkServerTrusted: function() {
            }, getAcceptedIssuers: function() {
              return [];
            } } });
            C.init.overload("[Ljavax.net.ssl.KeyManager;", "[Ljavax.net.ssl.TrustManager;", "java.security.SecureRandom").implementation = function(k, t, s) {
              this.init(k, [TA.$new()], s);
            };
            ok("SSLContext trust-all");
          } catch (e) {
          }
          try {
            var CP = Java.use("okhttp3.CertificatePinner");
            CP.check.overload("java.lang.String", "java.util.List").implementation = function(h) {
            };
            ok("OkHttp pinner");
          } catch (e) {
          }
          console.log("[*] Java/Conscrypt unpinning active");
        });
      }
      function rootBypass() {
        jperform(function() {
          ...
          try {
            ...
            ["isRooted", "isRootedWithoutBusyBoxCheck", "isRootedWithBusyBoxCheck", "checkForSuBinary", "checkForDangerousProps", "checkForRWPaths", "detectTestKeys", "checkSuExists", "checkForRootNative", "checkForMagiskBinary", "detectRootManagementApps", "detectPotentiallyDangerousApps", "checkForBusyBoxBinary"].forEach(function(m) {
              try {
          ...
          try {
            ...
            RBN.checkForRoot.implementation = function() {
              return 0;
            };
            try {
              RBN.exists.implementation = function() {
                return 0;
              };
            } catch (e) {
            }
          ...
          try {
            ...
            var bad = ["su", "magisk", "supersu", "superuser", "busybox", "daemonsu", "/data/adb"];
            F.exists.implementation = function() {
              try {
                var p = this.getAbsolutePath();
                if (p) {
                  p = p.toLowerCase();
                  for (var i = 0; i < bad.length; i++) if (p.indexOf(bad[i]) >= 0) return false;
                }
              } catch (e) {
              }
              return this.exists();
            };
            ok("File.exists su/magisk hidden");
          } catch (e) {
          }
          try {
            var R = Java.use("java.lang.Runtime");
            R.exec.overload("java.lang.String").implementation = function(c) {
              if (c && /(^|\/)su($| )|which\s+su|magisk|busybox/i.test(c)) c = "echo";
              return this.exec(c);
            };
            ok("Runtime.exec su filtered");
          } catch (e) {
          }
          try {
            var B = Java.use("android.os.Build");
            B.TAGS.value = "release-keys";
            ok("Build.TAGS=release-keys");
          } catch (e) {
          }
          try {
            var PM = Java.use("android.app.ApplicationPackageManager");
            var rp = ["com.topjohnwu.magisk", "eu.chainfire.supersu", "me.weishu.kernelsu", "com.kingroot.kinguser", "io.github.vvb2060.magisk", "com.rifsxd.ksunext"];
            PM.getPackageInfo.overload("java.lang.String", "int").implementation = function(n, f) {
              if (rp.indexOf(n) >= 0) throw Java.use("android.content.pm.PackageManager$NameNotFoundException").$new(n);
      ...
      function vpnBypass() {
        jperform(function() {
          ...
          try {
            ...
            ok("hasTransport(VPN)=false");
          } catch (e) {
          }
          try {
            var NI = Java.use("java.net.NetworkInterface");
            var gn = NI.getName;
            gn.implementation = function() {
              var n = gn.call(this);
              if (n && /^(tun|ppp|tap)/i.test(n)) return "rmnet0";
              return n;
            };
            ok("NetworkInterface masked");
          } catch (e) {
          }
          console.log("[*] VPN-detection bypass active");
        });
      }
      console.log("[*] Flutter Interceptor (frida17) opts: " + JSON.stringify(O));
      if (O.ssl) {
        try {
          runFlutterUnpin();
        } catch (e) {
          console.log("[!] flutter unpin: " + e);
        }
        javaSSL();
      }
      if (O.root) {
  ...
  var require_entry = __commonJS({
    "entry.js"() {
      ...
      var import_hooks_all = __toESM(require_hooks_all());
    }
  });
  require_entry();
})();
